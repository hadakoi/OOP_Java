...
public class Main {
  public static void main(String[] args) {
    // Find the maximum among three integers using the Maximum class
    int intMax = Maximum.max(3, 7, 5);
    System.out.println("Maximum among 3, 7, 5: " + intMax);
    // Output: Maximum among 3, 7, 5: 7

    // Find the maximum among three doubles using the Maximum class
    ...
    // Find the maximum value in an integer array using the Maximum class
    int[] array = {4, 9, 2, 6, 7};
    int arrayMax = Maximum.max(array);
    System.out.println("Maximum in the array: " + arrayMax);
    // Output: Maximum in the array: 9

    // Find the maximum value in a 2D integer matrix using the Maximum class
    int[][] matrix = {
      {5, 2, 9},
      {8, 7, 6},
      {1, 3, 4}
